...
// Plataforma 0km: estrutura pronta para dados reais. Sem mocks.
const kpis = [
  { icon: Building2, label: "Agências cadastradas", value: "0", delta: undefined, positive: true },
  { icon: CheckCircle2, label: "Agências ativas", value: "0", delta: undefined, positive: true },
  { icon: Package, label: "Pacotes ativos", value: "0", delta: undefined, positive: true },
  { icon: Inbox, label: "Leads gerados", value: "0", delta: undefined, positive: true },
...
const growth = [
  { label: "Novas agências", value: "0", sub: "últimos 30 dias" },
  { label: "Novos pacotes", value: "0", sub: "últimos 30 dias" },
  { label: "Novos leads", value: "0", sub: "últimos 30 dias" },
]
